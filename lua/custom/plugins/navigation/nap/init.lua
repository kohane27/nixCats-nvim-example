    ...
    after = function(plugin)
      require("nap").setup({
        ...
        operators = {
          ["d"] = {
            next = {
              rhs = "<cmd>lua require('lspsaga.diagnostic'):goto_next({ severity = vim.diagnostic.severity.ERROR })<CR>",
              opts = { desc = "Next diagnostic" },
            },
            prev = {
              rhs = "<cmd>lua require('lspsaga.diagnostic'):goto_prev({ severity = vim.diagnostic.severity.ERROR })<CR>",
          ...
          ["t"] = {
            ...
            prev = {
              rhs = '<cmd>lua require("todo-comments").jump_prev()<CR>',
